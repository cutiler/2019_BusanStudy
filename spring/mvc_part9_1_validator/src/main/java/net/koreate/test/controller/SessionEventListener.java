...
/*
	중복 로그인 방지
	implements HttpSessionListener, HttpSessionAttribueListener
*/
@Component
public class SessionEventListener implements HttpSessionListener, HttpSessionAttributeListener {
	...
	public static Hashtable<String, Object> sessionRepository = null;
	...
	public static SessionEventListener getInstance() {
